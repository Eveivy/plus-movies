            ...
            <Container fluid className='hero-section'>
                ...
                <Row className='h-75'>
                    <Col xl={8} className='d-flex justify-content-center flex-column text-white ms-xl-5 mt-xl-5'>
                        ...
                        of movies and TV shows. It features search and browse functionalities, personalized recommendations, user reviews, and watchlists. It app is a one-stop-shop for all things film and television.</p>
                        <div className='my-3'>
